  ...
  namespace detail {
    ...
    inline void write_help(std::ostream& out) {
      std::println(
        ...
        "  ADD,<orderid>,<side>,<quantity>,<price>     add_order_event      (side: BUY | SLL)\n"
        "  CXL,<orderid>                               cancel_order_event\n"
        "\n"
        "Output grammar:\n"
        "  TRD,<quantity>,<price>                     TradeEvent\n"
        "  FFL,<orderid>                               OrderFullyFilled\n"
        "  PFL,<orderid>,<remaining-quantity>           OrderPartiallyFilled\n"
        "  ERR,<orderid>,<error-kind-as-integer>       OrderError\n"
        "Flags:\n"
